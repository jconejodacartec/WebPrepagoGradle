package com.rbm.web.prepago.pagecode;
...
public abstract class PageCodeBase {
	...
	public PageCodeBase() {
		try {
			setConfigParamLdap(GestorConfiguracionLDAP.obtenerConfiguracionLdap(getConfigParamLdap()));
			setConfigMappingLdap(GestorConfiguracionLDAP.obtenerConfiguracionLdapMapeo(getConfigMappingLdap()));
	...
	public byte[] getByte(String a) throws IOException {
	...
	/**
	 * @return the configParamLdap
	 */
	public ConfiguracionParametrosLdap getConfigParamLdap() {
		return configParamLdap;
	}

	/**
	 * @param configParamLdap the configParamLdap to set
	 */
	public void setConfigParamLdap(ConfiguracionParametrosLdap configParamLdap) {
		this.configParamLdap = configParamLdap;
	}

	/**
	 * @return the configMappingLdap
	 */
	public ConfiguracionMapeoLdap getConfigMappingLdap() {
		return configMappingLdap;
	}

	/**
	 * @param configMappingLdap the configMappingLdap to set
	 */
	public void setConfigMappingLdap(ConfiguracionMapeoLdap configMappingLdap) {
		this.configMappingLdap = configMappingLdap;
	}
	...
	public PortletPreferences getPortletPreferences() {
		PortletRequest request = (PortletRequest) this.getFacesContext().getExternalContext().getRequest();
		return request.getPreferences();
	}
